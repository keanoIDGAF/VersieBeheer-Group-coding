...
<div class="card">
    ...
    <?php else: ?>
        <?php if (isset($error)) echo "<div class='msg' style='background:#fee; color:red'>$error</div>"; ?>
        <?php if (isset($success)) echo "<div class='msg' style='background:#efe; color:green'>$success</div>"; ?>
